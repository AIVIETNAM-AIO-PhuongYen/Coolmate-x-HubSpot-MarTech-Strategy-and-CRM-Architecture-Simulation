  ...
  <div class="products">
    <div class="product-card" data-action="Xem áo Polo Ex-Dry" data-pts="5">
      ...
      <div class="product-info">
        <div class="product-name">Áo Polo Ex-Dry Tech</div>
        <div class="product-sub">Công nghệ thấm hút nhanh</div>
    ...
    <div class="product-card" data-action="Xem Quần Jogger Anti-Smell" data-pts="5">
      ...
      <div class="product-info">
        <div class="product-name">Quần Jogger Anti-Smell</div>
        <div class="product-sub">Kháng khuẩn, co giãn 4 chiều</div>
        <div><span class="price-now">559.000đ</span><span class="price-old">749.000đ</span></div>
        <div class="product-actions">
          <button class="btn-add" data-action="Thêm giỏ — Jogger Anti-Smell" data-pts="15">Thêm giỏ hàng</button>
    ...
    <div class="product-card" data-action="Xem Áo Thun Kỹ Thuật" data-pts="5">
      ...
      <div class="product-info">
        <div class="product-name">Áo Thun Kỹ Thuật Pro</div>
        <div class="product-sub">Combo Ex-Dry + Anti-Smell</div>
    ...
    <div class="product-card" data-action="Xem Combo Tech-Wear Office" data-pts="7">
      ...
      <div class="product-info">
        ...
        <div class="product-sub">1 Polo + 1 Thun + 1 Jogger</div>
        <div><span class="price-now">999.000đ</span><span class="price-old">1.399.000đ</span></div>
        <div class="product-actions">
          <button class="btn-add" data-action="Thêm giỏ — Combo Tech-Wear" data-pts="20">Thêm giỏ hàng</button>
...
<div class="product-detail">
  ...
  <div>
    ...
    <div class="pd-rating" data-action="Xem đánh giá sản phẩm" data-pts="4">
      <span class="stars">★★★★★</span><span class="rating-count">4.8 (1.240 đánh giá)</span>
    </div>
    <div class="pd-price">
      <span class="pd-price-now">449.000đ</span>
      <span class="pd-price-old">599.000đ</span>
      <span class="pd-price-save">Giảm 25%</span>
    </div>
